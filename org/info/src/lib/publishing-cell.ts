...
export const PUBLISHING_SURFACE: PublishingSurface = 'info';

/** Which brand family this unit serves. Rails calls this `surface`. */
export const PUBLISHING_AUDIENCE: PublishingAudience = 'org';
...
export const CANONICAL_ORIGINS = {
  jp: 'https://info-jp.umaxica.org',
  us: 'https://info-us.umaxica.org',
} as const;
 ...
 */
export const PRIVATE_RAILS_ORIGIN = 'http://info.org.localhost:3000';
