# OWASP ASVS 5.0 Level 1–2 review: `com/core`
...
- `pnpm --dir com/core audit --prod --json`: 0 info / 0 low / 0 moderate / 0 high / 0 critical.
- `pnpm --dir com/core run test` (via `pnpm -r run test`): PASS, 31 files / 465 tests.
- `grep` over `com/core/src` for `dangerouslySetInnerHTML`, `innerHTML`, `eval(`,
...
Production `ratelimits` namespace ids in this unit: `5002 5102 2002 2102 3002 3102 1002 1102 `.
