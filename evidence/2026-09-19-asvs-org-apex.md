# OWASP ASVS 5.0 Level 1–2 review: `org/apex`
...
- `pnpm --dir org/apex audit --prod --json`: 0 info / 0 low / 0 moderate / 0 high / 0 critical.
- `pnpm --dir org/apex run test` (via `pnpm -r run test`): PASS, 19 files / 110 tests.
- `grep` over `org/apex/src` for `dangerouslySetInnerHTML`, `innerHTML`, `eval(`,
...
Production `ratelimits` namespace ids in this unit: `2003 3003 1003 `.
