...
export const PUBLISHING_SURFACE: PublishingSurface = 'news';

/** Which brand family this unit serves. Rails calls this `surface`. */
export const PUBLISHING_AUDIENCE: PublishingAudience = 'app';
...
export const CANONICAL_ORIGINS = {
  jp: 'https://news-jp.umaxica.app',
  us: 'https://news-us.umaxica.app',
} as const;
 ...
 */
export const PRIVATE_RAILS_ORIGIN = 'http://news.app.localhost:3000';
