/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 5924254f359fd67ac6a3534432a71d53)
// Runtime types generated with workerd@1.20260521.1 2026-05-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	RATE_LIMITER: RateLimit;
	VPC_SERVICE_APP_CORE?: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ENV" | "NODE_ENV" | "BRAND_NAME" | "NEXT_PUBLIC_APP_URL" | "NEXT_PUBLIC_SENTRY_DSN">> {}
}
