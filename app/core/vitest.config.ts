  ...
  test: {
    coverage: {
      exclude: [
        ...
        // Generated by `pnpm run i18n:compile` (paraglide-js). Hand-written
        // locale strategy lives in `src/i18n/paraglide-client.ts` and stays
        // measured; this directory is compiler output only.
        'src/paraglide/**',
