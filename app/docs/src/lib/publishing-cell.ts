...
export const PUBLISHING_SURFACE: PublishingSurface = 'docs';
...
export const CANONICAL_ORIGINS = {
  jp: 'https://docs-jp.umaxica.app',
  us: 'https://docs-us.umaxica.app',
} as const;
 ...
 */
export const PRIVATE_RAILS_ORIGIN = 'http://docs.app.localhost:3000';
