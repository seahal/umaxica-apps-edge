...
describe('route parameter and search boundaries', () => {
  ...
  it('keeps route head functions safe before loader data is available', () => {
    ...
    expect(
      routeHead(pageRoute, { params: { lang: 'ja', page: '2' }, loaderData: undefined }),
    ).toEqual({});
    expect(
    ...
    expect(pendingSearchHead.meta).not.toContainEqual({
      name: 'robots',
...
describe('route components and loader signals', () => {
  it.each(['ja', 'en'] as const)(
    'renders the %s about component from this surface copy',
    async (lang) => {
